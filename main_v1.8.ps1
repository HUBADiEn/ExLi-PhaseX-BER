...
.NOTES
    ...
    Version:        1.8
    Änderungshistorie:
        1.8 - DEBUG-Ausgaben entfernt (Produktiv-Version)
        1.7 - Fix: $PSScriptRoot statt $MyInvocation (funktioniert in Funktionen)
        1.6 - Debug: Pfad-Ausgabe vor Verzeichnis-Pruefung
        1.5 - Fix: Join-Path in zwei Schritten (Backslash-Problem behoben)
        1.4 - Input-Pfad dynamisch: Übergeordneter Script-Ordner + PIM\PhaseX_Berechnung
            - Kein OneDrive-Registry-Lookup mehr nötig
...
# =====================================================================
$script:ModuleVersion_Main = "1.8"

# HINWEIS: $global:ScriptVersion wird von Start.ps1 gesetzt (z.B. "Berechnung_V1.9")
...
function Invoke-MainLogic {
    try {
        ...
        # V1.7: Input-Pfad dynamisch ermitteln
        # Script liegt in: ...\<Root>\Smart - Scripte\Migration - Berechnung\
        # Input liegt in:  ...\<Root>\PIM\PhaseX_Berechnung\
        # Also: 2 Ebenen hoch, dann PIM\PhaseX_Berechnung
        
        # WICHTIG: $PSScriptRoot funktioniert auch in Funktionen korrekt
        # $MyInvocation.MyCommand.Definition gibt in Funktionen den Funktions-Body zurueck!
        ...
        # Zwei Ebenen hoch zum Root (z.B. OneDrive-Ordner)
        $parentDir = Split-Path -Parent $scriptDir           # Eine Ebene hoch
        $rootDir = Split-Path -Parent $parentDir             # Zwei Ebenen hoch
