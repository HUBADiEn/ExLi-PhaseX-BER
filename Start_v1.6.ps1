...
.NOTES
    ...
    Benötigte Module:
        - config_v1.0.ps1            (ModuleVersion_Config = 1.0)
        ...
        - functions-checks_v1.3.ps1  (ModuleVersion_Checks = 1.3)
        - main_v1.2.ps1              (ModuleVersion_Main = 1.2)  <-- NEU
#>

# =====================================================================
# START-SCRIPT VERSION (wird fuer gesamtes Script verwendet)
# =====================================================================
$script:StartVersion = "1.6"

# Diese Variable wird von main.ps1 verwendet fuer Output und Fenster
$script:ScriptVersion = "Berechnung_V$($script:StartVersion)"

# =====================================================================
# BENÖTIGTE MODUL-VERSIONEN (Reihenfolge wichtig: config zuerst, main zuletzt)
# =====================================================================
$script:RequiredModules = [ordered]@{
    'config'           = @{ File = 'config_v1.0.ps1';            Variable = 'ModuleVersion_Config';  Version = '1.0' }
    ...
    'functions-checks' = @{ File = 'functions-checks_v1.3.ps1';  Variable = 'ModuleVersion_Checks';  Version = '1.3' }
    'main'             = @{ File = 'main_v1.2.ps1';              Variable = 'ModuleVersion_Main';    Version = '1.2' }
}
