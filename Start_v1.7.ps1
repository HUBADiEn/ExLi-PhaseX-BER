...
.NOTES
    ...
    Benötigte Module:
        ...
        - functions-checks_v1.4.ps1  (ModuleVersion_Checks = 1.4)
        - main_v1.3.ps1              (ModuleVersion_Main = 1.3)
#>

# =====================================================================
# START-SCRIPT VERSION (wird fuer gesamtes Script verwendet)
# =====================================================================
$script:StartVersion = "1.7"
...
$script:RequiredModules = [ordered]@{
    ...
    'functions-checks' = @{ File = 'functions-checks_v1.4.ps1';  Variable = 'ModuleVersion_Checks';  Version = '1.4' }
    'main'             = @{ File = 'main_v1.3.ps1';              Variable = 'ModuleVersion_Main';    Version = '1.3' }
}
